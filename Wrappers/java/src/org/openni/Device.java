...
public class Device {
	 ...
	 */
	public static Device open(String uri, int fd) {
		Device device = new Device();
		NativeMethods.checkReturnStatus(NativeMethods.oniDeviceOpen(uri, device, fd));
		if (device.isFile())
		{
	 ...
	 * requesting a list of all devices and iterating through it would be a waste of effort.
	 */
	public static Device open(int fd) {
		Device device = new Device();
		NativeMethods.checkReturnStatus(NativeMethods.oniDeviceOpen(device, fd));
		if (device.isFile())
		{
			device.mPlaybackControl = new PlaybackControl(device);
		}
